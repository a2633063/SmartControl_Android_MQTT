...
public class S7SettingFragment extends SettingFragment {
    final static String Tag = "S7SettingFragment";
    ...
    private S7OTAInfo otaInfo = new S7OTAInfo();
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            msg.what = 2;
                            String res = WebService.WebConnect("https://gitee.com/api/v5/repos/a2633063/Release/releases/tags/zS7");
                            msg.obj = res;
                ...
                case 2:
                    ...
                    try {
                        ...
                        if (obj.getString("name").equals("zS7发布地址_" + otaInfo.tag_name)) {
    ...
    public S7SettingFragment(DeviceS7 device) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.s7_setting);
        ...
        fw_version.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        otaInfo = new S7OTAInfo();
                        Message msg = new Message();
                        msg.what = 0;
                        String res = WebService.WebConnect("https://gitee.com/api/v5/repos/a2633063/zS7/releases/latest");
                        msg.obj = res;
                        handler.sendMessageDelayed(msg, 0);// 执行耗时的方法之后发送消给handler
                    }
                }).start();
            ...
            if (jsonSetting != null) {
                ...
                if (jsonSetting.has("ota1") ||jsonSetting.has("ota2")) {
                    ...
                    if (ota_uri1.startsWith("http") || ota_uri2.startsWith("http") ) {
                        ...
                        pd.setCanceledOnTouchOutside(false);
                        pd.setMessage("正在更新固件,此过程请保证S7屏幕点亮!\n大约15秒左右,请稍后....\n若时间过长,请手动关闭此窗口\n此弹窗可以直接关闭,不影响ota结果");
                        pd.show();
