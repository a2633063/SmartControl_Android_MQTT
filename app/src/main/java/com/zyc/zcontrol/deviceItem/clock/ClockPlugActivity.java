...
public class ClockPlugActivity extends ServiceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(ClockPlugActivity.this, "数据错误!请联系开发者", Toast.LENGTH_SHORT).show();
            finish();
        }
        ...
        adapter = new ClockTaskListAdapter(ClockPlugActivity.this, data, new ClockTaskListAdapter.Callback() {
            @Override
        ...
        tv_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final EditText mEditText = new EditText(ClockPlugActivity.this);
                mEditText.setText(tv_name.getText());
                mEditText.setHint("建议长度在8个字以内");
                AlertDialog.Builder builder = new AlertDialog.Builder(ClockPlugActivity.this);
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (str.length() > 16)
                                    ...
                                    Toast.makeText(ClockPlugActivity.this, "名称不能为空!", Toast.LENGTH_SHORT).show();
                                    return;
                                }
