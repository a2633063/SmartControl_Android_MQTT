...
public class S7LinkActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void onWifiChanged(WifiInfo info) {
        ...
        if (!connected) {
            ...
            if (mTask != null) {
                ...
                mTask = null;
                new AlertDialog.Builder(S7LinkActivity.this)
                        .setMessage("Wifi disconnected or changed")
                        .setNegativeButton(android.R.string.cancel, null)
                        .show();
            }
        } else {
            String ssid = Function.getSSID(S7LinkActivity.this);
    ...
    public void onClick(View v) {
        if (v == mConfirmBtn) {
            ...
            mTask = new EsptouchAsyncTask4(S7LinkActivity.this, handler);
    ...
    private void onEsptoucResultAddedPerform(final IEsptouchResult result) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(S7LinkActivity.this, text,
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        private WeakReference<S7LinkActivity> mActivity;
        ...
        EsptouchAsyncTask4(S7LinkActivity activity, Handler handler) {
        ...
        protected List<IEsptouchResult> doInBackground(byte[]... params) {
            S7LinkActivity activity = mActivity.get();
            int taskResultCount;
            synchronized (mLock) {
