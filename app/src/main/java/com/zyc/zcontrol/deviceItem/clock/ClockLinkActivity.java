...
public class ClockLinkActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clock_link);
    ...
    private void onWifiChanged(WifiInfo info) {
        ...
        if (!connected) {
            ...
            if (mTask != null) {
                ...
                mTask = null;
                new AlertDialog.Builder(ClockLinkActivity.this)
                        .setMessage("Wifi disconnected or changed")
                        .setNegativeButton(android.R.string.cancel, null)
                        .show();
            }
        } else {
            String ssid = Function.getSSID(ClockLinkActivity.this);
    ...
    public void onClick(View v) {
        if (v == mConfirmBtn) {
            ...
            byte[] deviceCount = "1".getBytes();    //设备数量为1
            ...
            mTask = new EsptouchAsyncTask4(ClockLinkActivity.this, handler);
    ...
    private void onEsptoucResultAddedPerform(final IEsptouchResult result) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(ClockLinkActivity.this, text,
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        private WeakReference<ClockLinkActivity> mActivity;
        ...
        EsptouchAsyncTask4(ClockLinkActivity activity, Handler handler) {
        ...
        protected List<IEsptouchResult> doInBackground(byte[]... params) {
            ClockLinkActivity activity = mActivity.get();
            int taskResultCount;
            synchronized (mLock) {
