...
public class Key51SettingFragment extends SettingFragment {
    final static String Tag = "Key51SettingFragment";
    ...
    private Key51OTAInfo otaInfo = new Key51OTAInfo();
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            msg.what = 2;
                            String res = WebService.WebConnect("https://gitee.com/api/v5/repos/a2633063/Release/releases/tags/zKey51");
                            msg.obj = res;
                ...
                case 2:
                    ...
                    try {
                        ...
                        if (obj.getString("name").equals("zKey51发布地址_" + otaInfo.tag_name)) {
    ...
    public Key51SettingFragment(DeviceKey51 device) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.key51_setting);
        ...
        fw_version.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        otaInfo = new Key51OTAInfo();
                        Message msg = new Message();
                        msg.what = 0;
                        String res = WebService.WebConnect("https://gitee.com/api/v5/repos/a2633063/zKey51/releases/latest");
                        msg.obj = res;
                        handler.sendMessageDelayed(msg, 0);// 执行耗时的方法之后发送消给handler
                    }
                }).start();
