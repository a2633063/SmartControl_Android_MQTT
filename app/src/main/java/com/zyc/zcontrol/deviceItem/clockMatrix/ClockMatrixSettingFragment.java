...
public class ClockMatrixSettingFragment extends SettingFragment {
    ...
    private ClockMatrixOTAInfo otaInfo = new ClockMatrixOTAInfo();
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            msg.what = 2;
                            String res = WebService.WebConnect("https://gitee.com/api/v5/repos/a2633063/Release/releases/tags/zClock_Matrix");
                            msg.obj = res;
                ...
                case 2:
                    ...
                    try {
                        ...
                        if (obj.getString("name").equals("zClock_Matrix发布地址_" + otaInfo.tag_name)) {
    ...
    public ClockMatrixSettingFragment(DeviceClockMatrix device) {
        ...
        fw_version.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        otaInfo = new ClockMatrixOTAInfo();
                        Message msg = new Message();
                        msg.what = 0;
                        String res = WebService.WebConnect("https://gitee.com/api/v5/repos/a2633063/zClock_Matrix/releases/latest");
                        msg.obj = res;
                        handler.sendMessageDelayed(msg, 0);// 执行耗时的方法之后发送消给handler
                    }
                }).start();
