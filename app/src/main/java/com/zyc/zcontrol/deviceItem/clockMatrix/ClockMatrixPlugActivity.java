...
public class ClockMatrixPlugActivity extends ServiceActivity {
    public final static String Tag = "ClockPlugActivity";

    private SwipeRefreshLayout mSwipeLayout;
    ListView lv_task;
    ArrayList<TaskItem> data = new ArrayList<>();
    ClockMatrixTaskListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clock_plug);
        ...
        try {
            ...
            device = (DeviceClock) ((MainApplication) getApplication()).getDevice(intent.getStringExtra("mac"));
            if (device == null || plug_id < 0 || plug_id > 3) {
                throw new Exception("获取数据出错:" + intent.getStringExtra("mac") + "," + plug_id); // 异常信息
            }
        } catch (Exception e) {
            e.printStackTrace();
            Toast.makeText(ClockMatrixPlugActivity.this, "数据错误!请联系开发者", Toast.LENGTH_SHORT).show();
            finish();
        }
        ...
        adapter = new ClockMatrixTaskListAdapter(ClockMatrixPlugActivity.this, data, new ClockMatrixTaskListAdapter.Callback() {
            @Override
        ...
        tv_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final EditText mEditText = new EditText(ClockMatrixPlugActivity.this);
                mEditText.setText(tv_name.getText());
                mEditText.setHint("建议长度在8个字以内");
                AlertDialog.Builder builder = new AlertDialog.Builder(ClockMatrixPlugActivity.this);
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (str.length() > 16)
                                    ...
                                    Toast.makeText(ClockMatrixPlugActivity.this, "名称不能为空!", Toast.LENGTH_SHORT).show();
                                    return;
                                }
    ...
    private void popupwindowTask(final int task_id) {
        ...
        final View popupView = getLayoutInflater().inflate(R.layout.popupwindow_clock_set_time, null);
    ...
    private void popupwindowCountDown() {
        ...
        final View popupView = getLayoutInflater().inflate(R.layout.popupwindow_clock_set_time_count_down, null);
        final PopupWindow window = new PopupWindow(popupView, MATCH_PARENT, MATCH_PARENT, true);//wrap_content,wrap_content
