...
class ClockMatrixTaskListAdapter extends BaseAdapter {
    ...
    public ClockMatrixTaskListAdapter(Context context, List data) {
        this.context = context;
        this.mdata = data;
        inflater = LayoutInflater.from(context);
    }

    public ClockMatrixTaskListAdapter(Context context, List data, Callback callback) {
        this.context = context;
        this.mdata = data;
        inflater = LayoutInflater.from(context);
        mCallback = callback;
    ...
    public View getView(final int position1, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.list_item_clock_task_list, null);
