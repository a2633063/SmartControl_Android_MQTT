...
public class C1SettingFragment extends SettingFragment {
    final static String Tag = "C1SettingFragment";
    ...
    private C1OTAInfo otaInfo = new C1OTAInfo();
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            msg.what = 2;
                            String res = WebService.WebConnect("https://gitee.com/api/v5/repos/a2633063/Release/releases/tags/zC1");
                            msg.obj = res;
                ...
                case 2:
                    ...
                    try {
                        ...
                        if (obj.getString("name").equals("zC1发布地址_" + otaInfo.tag_name)) {
    ...
    public C1SettingFragment(DeviceC1 device) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.c1_setting);
        ...
        fw_version.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        otaInfo = new C1OTAInfo();
                        Message msg = new Message();
                        msg.what = 0;
                        String res = WebService.WebConnect("https://gitee.com/api/v5/repos/a2633063/zC1/releases/latest");
                        msg.obj = res;
                        handler.sendMessageDelayed(msg, 0);// 执行耗时的方法之后发送消给handler
                    }
                }).start();
