...
public class DC1LinkActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void onWifiChanged(WifiInfo info) {
        ...
        if (!connected) {
            ...
            if (mTask != null) {
                ...
                mTask = null;
                new AlertDialog.Builder(DC1LinkActivity.this)
                        .setMessage("Wifi disconnected or changed")
                        .setNegativeButton(android.R.string.cancel, null)
                        .show();
            }
        } else {
            String ssid = Function.getSSID(DC1LinkActivity.this);
    ...
    public void onClick(View v) {
        if (v == mConfirmBtn) {
            ...
            mTask = new EsptouchAsyncTask4(DC1LinkActivity.this, handler);
    ...
    private void onEsptoucResultAddedPerform(final IEsptouchResult result) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(DC1LinkActivity.this, text,
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        private WeakReference<DC1LinkActivity> mActivity;
        ...
        EsptouchAsyncTask4(DC1LinkActivity activity, Handler handler) {
        ...
        protected List<IEsptouchResult> doInBackground(byte[]... params) {
            DC1LinkActivity activity = mActivity.get();
            int taskResultCount;
            synchronized (mLock) {
