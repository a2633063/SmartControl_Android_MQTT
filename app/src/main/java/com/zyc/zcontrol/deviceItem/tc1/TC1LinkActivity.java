...
public class TC1LinkActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("EasylinkActivity", "ssid:" + Function.getSSID(TC1LinkActivity.this));
    ...
    private void onWifiChanged(WifiInfo info) {
        ...
        if (!connected) {
            ...
            String ssid = Function.getSSID(TC1LinkActivity.this);
    ...
    public void onClick(View v) {
        if (v == mConfirmBtn) {
            mProgressDialog = new ProgressDialog(TC1LinkActivity.this);
        ...
        try {
            ...
            if (jsonObject.has("name") && jsonObject.has("mac") && jsonObject.has("type_name")) {
                ...
                if (type_name.equals("zTC1")) {
                    ...
                    mResultDialog = new AlertDialog.Builder(TC1LinkActivity.this).create();
